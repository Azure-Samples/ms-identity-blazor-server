...
#> 
   ...
   Write-Host "Creating the AAD application (WebApp-blazor-server-call-graph)"
   ...
   $webAppAadApplication = New-AzureADApplication -DisplayName "WebApp-blazor-server-call-graph" `
                                                  ...
                                                  -IdentifierUris "https://$tenantName/WebApp-blazor-server-call-graph" `
   ...
   Write-Host "Done creating the webApp application (WebApp-blazor-server-call-graph)"
   ...
   Add-Content -Value "<tr><td>webApp</td><td>$currentAppId</td><td><a href='$webAppPortalUrl'>WebApp-blazor-server-call-graph</a></td></tr>" -Path createdApps.html
   ...
   $configFile = $pwd.Path + "\..\blazorserver-calls-MS-graph\appsettings.json"
